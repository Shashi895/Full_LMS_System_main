...
const Hero = () => {
  return (
    <div className='flex flex-col items-center justify-center w-full md:pt-36 pt-20  px-7 md:px-0 space-y-7 text-center'>
      <h1 className='text-lg md:text-3xl relative font-bold text-white max-w-3xl mx-auto uppercase'>“Empower your future with courses crafted for your”<span className='text-blue-600'>success.</span><img  src="/src/assets/sketch.png" alt="sketch" className='md:block hidden absolute bottom-9 right-0 w-[40%]' /></h1>
